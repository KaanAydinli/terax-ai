...
export function Header({
  ...
  const editorCount = tabs.filter((tab) => tab.kind === "editor").length;
    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        ...
        >
          ...
          {IS_MAC && (
            <span className="mr-1 h-full w-px shrink-0 bg-border/70" />
          )}
      ...
      <ContextMenuContent className="min-w-44">
        <ContextMenuItem disabled={tabs.length <= 1} onSelect={onCloseAllTabs}>
          Close All Tabs
        </ContextMenuItem>
        <ContextMenuItem
          disabled={editorCount === 0}
